...
const testimonials = [
  {
    quote: "Our traders typed plain English requests and settled directly on-chain in minutes. No order book training needed.",
    author: "Amina Park",
    role: "Head of Trading",
    company: "North Harbor Digital",
    metric: { value: "<60s", label: "Chat-to-trade time" },
  },
  {
    quote: "The on-chain offer flow made compliance reviews simple. Every request and execution had a verifiable transaction trail.",
    author: "Leon Ward",
    role: "Compliance Lead",
    company: "Crestline Markets",
    metric: { value: "100%", label: "On-chain auditability" },
  },
  {
    quote: "AtomicSwap removed partial-fill risk for our OTC desk. One acceptance, one transaction, fully settled.",
    author: "Noah Ibrahim",
    role: "OTC Lead",
    company: "Signal Ridge",
    metric: { value: "1 TX", label: "Atomic settlement" },
  },
  {
    quote: "The reputation registry helped us evaluate counterparties quickly. Trust improved after every successful execution.",
    author: "Maya Sinclair",
    role: "Risk Manager",
    company: "Orion Treasury",
    metric: { value: "+1", label: "Per successful trade" },
  },
];

const ASCII_PATTERN = Array.from({ length: 60 }, (_, i) =>
  Array.from({ length: 100 }, (_, j) => (((i * 37 + j * 17) % 11) < 3 ? '"' : " ")).join("")
).join("\n");
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              Built for real
              <span className="text-background/40"> trading teams.</span>
            </h2>
          </div>
