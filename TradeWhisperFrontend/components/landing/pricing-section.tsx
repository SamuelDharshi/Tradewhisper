...
const plans = [
  {
    name: "Demo",
    description: "For hackathon demos and local testing",
    price: { monthly: 0, annual: 0 },
    features: [
      "HashKey testnet setup",
      "Basic request and offer flow",
      "Community support",
      "Trade event logs",
  ...
  {
    name: "Market Maker",
    description: "For teams running live quote operations",
    price: { monthly: 79, annual: 65 },
    features: [
      "Signed offer automation",
      "Live oracle pricing",
      "Priority support",
      "Full audit trails",
  ...
  {
    name: "Institutional",
    description: "For compliant high-volume OTC desks",
    price: { monthly: null, annual: null },
    features: [
      "Custom settlement limits",
      "Advanced monitoring",
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20">
          <div className="lg:col-span-7">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
              ...
              Pay for
              <br />
              <span className="text-stroke">settlement.</span>
            </h2>
          </div>
