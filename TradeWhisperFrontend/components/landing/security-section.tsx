...
const securityFeatures = [
  {
    icon: Shield,
    title: "Signed offer flow",
    description: "Each offer is signed and verified before execution.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Atomic settlement",
    description: "Both legs settle together or the trade does not execute.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Full audit trails",
    description: "Requests, offers, and executions are immutable on-chain.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Reputation scoring",
    description: "Successful settlements increment market-agent trust on-chain.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["EIP-712", "AtomicSwap", "On-chain Logs", "Reputation"];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
            ...
            Atomic,
            <br />
            <span className="text-muted-foreground">and auditable.</span>
          </h2>
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              TradeWhisper is designed for verifiable trust: signed offers, immutable events, and a public reputation layer.
            </p>
          </div>
        </div>
