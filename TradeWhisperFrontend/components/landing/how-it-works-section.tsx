...
const steps = [
  {
    ...
    description: "Type a trade request in natural language. The AI parser extracts token pair, amount, and constraints into structured intent.",
    code: `{
  intent: 'TRADE',
  tokenIn: 'USDC',
  amountIn: 10,
  ...
  },
  {
    ...
    title: "Receive",
    subtitle: "live offer",
    description: "A market agent listens on-chain, reads oracle pricing, applies spread rules, and submits a signed TRADE_OFFER.",
    code: `submitOffer({
  requestId,
  amountOut,
  expiry,
  ...
  },
  {
    ...
    title: "Settle",
    subtitle: "atomically",
    description: "Accept once. AtomicSwap executes both legs in one transaction, then reputation is updated on-chain.",
    code: `executeTrade(offer)
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block">Whisper.</span>
              <span className="block text-white/30">Offer.</span>
